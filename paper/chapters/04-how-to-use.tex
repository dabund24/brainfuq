...
To ensure dependencies do not conflict with system-wide Python installations, we intend executing this project within an isolated virtual environment. 
From the project's root directory, the environment should be initialized and activated. Afterwards, the package can be installed along with its required dependencies in editable mode:
