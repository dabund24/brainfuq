...
In the following, we will look at the script \texttt{examples/ghz.py} (see Listing~\ref{lst:ghz_example}) to see how to interpret a \bfck{} program that creates a GHZ-State and how to translate it into a qiskit circuit.
